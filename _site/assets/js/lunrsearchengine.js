...
var documents = [{
    ...
    "title": "",
    "body": "About Me: Hello! I'm Évora Leite, a Junior Cybersecurity Analyst passionate about protecting digital assets and understanding cyber threats. I specialize in Cyber Threat Intelligence (CTI), Blue Team operations, and Computer Network Defense. My Expertise: Cyber Threat Intelligence (CTI): Analyzing threat actors, campaigns, and indicators of compromiseBlue Team Operations: Defensive security, incident response, and threat huntingNetwork Security: Computer network defense and monitoringPhishing Analysis: Email security and social engineering detectionSecurity Tools: VirusTotal, Hybrid-Analysis, MITRE ATT&amp;CK, BurpSuiteCurrent Focus: I'm currently working on developing automated threat intelligence workflows and improving organizational security postures through comprehensive phishing analysis and mitigation strategies. This blog serves as a platform to share my research, methodologies, and insights from the cybersecurity field. I believe in knowledge sharing and contributing to the security community. Get in TouchGitHub LinkedIn Email "
    }, {
    "id": 2,
    ...
    "title": "Home",
    "body": "      Featured:                                                                                                                                                                                                           Script básico de automação de busca no Virus Total                              :               Desenvolvimento de script Python para automatizar consultas na API do VirusTotal e otimizar workflows de CTI. :                                                                                                                                                                       Evs                                05 Jul 2025                                                                                                                                                                                                                                                                                                                  CIT aplicada à análise de phishing corporativo - Parte 1                              :               Nesta primeira parte, teremos::                                                                                                                                                                       Evs                                04 Jul 2025                                                                                                                      All Stories:             "
    }, {
    "id": 4,
    ...
    "id": 5,
    "url": "http://localhost:4000/Virustotal-script/",
    "title": "Script básico de automação de busca no Virus Total",
    "body": "2025/07/05 - Após minhas aventuras pela CTI e suas ferramentas, descobri que o Virus Total possui uma API e que eu poderia usá-la para automaizar minhas buscas e torná-las mais rápidas e fáceis. Bem, ao final a busca realmente se tornou mais rápida e fácil, mas desenvolver a solução não foi tão fácil assim. Como já adiantei, resolvi desenvolver um script para automatizar minhas buscas no Virus Total. Primeiramente pensei em usar bash, mas como tive pouco contato cheguei à conclusão que talvez eu fosse complicar (sem necessidade) um problema fácil de solucionar. Depois, fiquei entre usar JavaScript, o qual usei por alguns anos como desenvolvedora front-end, e Python, o qual usei bastante em um mestrado em Ciências da Computação que nem cheguei a terminar. Acabei decidindo em usar Python, pois acho uma linguagem “acessível” e organizada, além de ser um pouco mais user friendly. A verdade é que estou enferrujadíssima na programação e eu queria uma solução rápida, já que meu foco não é programar e sim usar a programação como uma ferramenta a mais (não uma complicação a mais). Aqui contarei um pouco da minha saga com esse processo de reconexão com a programação e os conhecimentos que (re)adquiri. Meu racicínio foi primeiro buscar quais resultador a API traria numa consulta de IP. "
    }, {
    "id": 6,
    "url": "http://localhost:4000/CTI-report-1/",
